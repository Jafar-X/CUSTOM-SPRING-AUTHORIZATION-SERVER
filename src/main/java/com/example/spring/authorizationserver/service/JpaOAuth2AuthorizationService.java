package com.example.spring.authorizationserver.service;
...
public class JpaOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public OAuth2Authorization findByToken(String token, OAuth2TokenType tokenType) {
        ...
        if (tokenType == null) {
            ...
            result = authorizationRepository.findByStateOrAuthorizationCodeValueOrAccessTokenValueOrRefreshTokenValue(token, token, token, token);
    ...
    private Map<String, Object> parseMap(String data) {
        try {
            return data != null ? objectMapper.readValue(data, new TypeReference<Map<String, Object>>() {}) : new HashMap<>();
        } catch (Exception ex) {
